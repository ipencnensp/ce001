...
- **02/05 (Qua)**: (7) Inferência estatística - estimação.
- **04/05 (Sex)**: Exercícios.
- **09/05 (Qua)**: Sabatina 7.
- **11/05 (Sex)**: (8) Inferência estatística - testes de hipótese.
...
- **06/06 (Qua)**: (9) Tópicos especiais I.
- **08/06 (Sex)**: Exercícios.
- **13/06 (Qua)**: Sabatina 9.
- **15/06 (Sex)**: (9) Tópicos especiais II.
