...
- outras medidas de posição
    ...
    - quantis: 1o quartil, 3o quartil, percentil 5%, entre outras
...
soma dos produtos dos valores pelas respectivas frequencias e divide pela frequencia total
...
Usar**ponto médio** de cada classe e respectivas frequencias 
...
Notar a influencia de valores extremos na média
...
Devido a esse fato, a mediana é uma medida de posição central **robusta**,
...
Alternativa, usar $(E(X))^2$ e $E(X^2) = \sum_{i=1}^k x_i^2 p_i$
