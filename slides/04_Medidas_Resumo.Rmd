...
$$
\bar{x}_{obs} = \frac{x_1 + x_2, \ldots, x_n}{n} = \frac{\sum_{i=1}^n
x_i}{n}.
$$

$$\bar{x}_{obs} = \frac{n_1 x_1 + n_2 x_2 + \ldots + n_k x_k}{n_1 + n_2 + \ldots
...
- Variância $var_{obs} = \frac{1}{n}\sum_{i=1}^n (x_i - \bar{x}_{obs})^2$
