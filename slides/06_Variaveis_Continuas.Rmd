...
Para $n \to \infty$, podemos aproximar a binomial pela normal, usando
$$
...
\begin{align*}
P(X \geq 50) \approx P(Y \geq 50) &= P\left(\frac{Y-60}{\sqrt{42}} \geq
\frac{50-60}{\sqrt{42}}\right) \\
 &= P(Z \geq -1.54) = 0.9382
\end{align*}
...
pnorm(50, mean = 60, sd = sqrt(42), lower.tail = FALSE)
```
