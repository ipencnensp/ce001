...
2. Determine o nível de confiança $\gamma$, e encontre o valor crítico
  $t_{\gamma/2}$
3. Calcule a margem de erro $e = t_{\gamma/2} \cdot (\sigma/\sqrt{n})$
4. Calcule $\text{IC}(\mu, \gamma)$
...
Assim, sabemos que
$$
p \sim \text{N} \left( p, \frac{p(1-p)}{n} \right)
$$
...
global
b) Com base nesse resultado, podemos concluir que a maioria dos
