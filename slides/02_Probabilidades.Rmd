...
a. A primeira carta é reposta no baralho antes da extração da
segunda carta.
b. A primeira carta extraída não é reposta antes da extração da
segunda carta.
...
desajustes com probabilidade $0.05$ e $0.10$; respectivamente. No início
do dia de operação um teste é realizado e, caso a máquina esteja fora de
...
\begin{align*}
P(F_1|A) &= \frac{P(A|F_1)P(F_1)}
{P(A|F_1)P(F_1) + P(A|F_2)P(F_2) + P(A|F_2)P(F_2)} \\
  &= \frac{0,2 \times 0,2}
